<template>
  <div>
    ...
    <div id="search">
      <div id="name-search">
        ...
        <select v-model="lastname" class="select" style="width:120px;">
            <option disabled selected>--Lastame--</option>
    ...
    <div class="map"><img class="map" src="../../../backend/patterns/A2_Data/MC2-tourist.jpg"></div>
		<div class="map"><div id="location"></div></div>
  </div>
</template>
