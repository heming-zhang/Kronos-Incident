...
def init_text():
    text = "Many of the Abila, Kronos-based employees of GAStech have company cars that are approved for both personal and business use. Those who do not have company cars have the ability to check out company trucks for business use, but these trucks cannot be used for personal business."
